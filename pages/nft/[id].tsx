    ...
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
            ...
            <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
                ...
                <div className="space-y-2 p-5 text-center">
                    ...
                    <h2 className="text-xl text-gray-300">
                        A collection of PAPAFAM Apex who live and breathe React
                    </h2>
                </div>
            </div>
        </div>
        ...
        <div className="flex flex-1 flex-col p-12 lg:col-span-6">
            ...
            <header className="flex items-center justify-between">
                ...
                <button onClick={() => address ? disconnect() : connectWithMetamask()} className="rounded-full bg-rose-400 
                text-white px-4 py-2 text-xm 
                font-bold lg:px-5 lg:py-3 
                lg:text-base"> 
            ...
            {/* Mint Button */}
            <button className="h-16 w-full bg-red-600 w-full text-white rounded-full mt-10 font-bold">
                Mint Nft (0.01 ETH)
            </button>
        </div>
    </div>
